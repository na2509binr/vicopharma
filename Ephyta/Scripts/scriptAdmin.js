...
function chartJs() {
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Thống kê bài viết theo tháng',
                backgroundColor: '#079AA6',
                borderColor: '#06737C',
                data: [0, 10, 5, 2, 6, 12, 12, 12, 20, 24]
            }]
        },
        options: {
            scales: {
...
$("#feedback").on("submit", function (e) {
    e.preventDefault();
    $.post("/Vcms/ContactUs", $(this).serialize(), function (data) {
        if (data.status) {
            alert(data.msg);
...
//$("#DiscountCode_ExpDay").datetimepicker({
//    inline: true,
//    minDate: 0,
//});